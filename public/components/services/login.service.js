(() => {
  ...
  servicioLogin.$inject = ['$log', '$http', 'servicioUsuarios', 'dataStorageFactory'];

  function servicioLogin($log, $http, servicioUsuarios, dataStorageFactory, localStorageFactory) {
